////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////
// *** HEADER FILE -- TYPEDEF_FUNCTIONS.H
////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////
/*
...
////////////////////////////////////////////////////////////////
	...
	{	
		...
		typenode = typenode->typenext;
		typenode->type_name = (char *) malloc(STRING_LIMIT);
...
////////////////////////////////////////////////////////////////
	...
	param_string 	 = (char *) malloc(STRING_LIMIT);
	strcpy(param_string, upper(typedefname));
	...
	while (typenode && (result == NO))
	{
		...
		linkedlist_string 	 = (char *) malloc(STRING_LIMIT);		
		strcpy(linkedlist_string, upper(typenode->type_name));
...
////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////
// *** END HEADER FILE -- TYPEDEF_FUNCTIONS.H
////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////