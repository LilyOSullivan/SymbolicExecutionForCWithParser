...
////////////////////////////////////////////////////////////////
	...
	// allocate space to the string variables used
	returnstr 	 = (char *) malloc(STRING_LIMIT);
	commastring	 = (char *) malloc(STRING_LIMIT);
	...
	if(strstr(struct_string, ",") != NULL)	
	{
		...
		strcpy(returnstr, copystring(commastring, 1, strlen(commastring)));		
	}
	else
	/////////////////////////////////////////////////////////////////
