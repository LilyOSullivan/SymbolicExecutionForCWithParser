...
////////////////////////////////////////////////////////////////////
	...
	////////////////////////////////////////////////////////////////////
	// allocate space to strings and initialise as appropriate
	C_name = (char *) malloc(STRING_LIMIT);
...
////////////////////////////////////////////////////////////////////
	...
	////////////////////////////////////////////////////////////////////
	// allocate space to strings and initialise variables as appropriate
...
////////////////////////////////////////////////////////////////
	...
	char * returnstr;					// return string of the function
  	char holdstr[STRING_LIMIT];	// temporary holding string
...
////////////////////////////////////////////////////////////////
	...
	// variable declarations
	char * returnstr;		// return string of the function
	char *istr = "";		// temporary holding string
...
/////////////////////////////////////////////////////////////////
	...
	char * returnstr;					 // return string of function
	...
	else if (strcmp(unary_op, "dereference") == 0)
	{
		...
		if ((strlen(cast_exp)) != i)
		{
			...
			strcat(returnstr, "("); strcat(returnstr, new_cast_exp); strcat(returnstr, ")");
		}
		/////////////////////////////////////////////////////////////////
		// Surround cast_exp with brackets
		else
		{
			strcat(returnstr, "("); strcat(returnstr, cast_exp); strcat(returnstr, ")");
		}
...
////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////
// *** END HEADER FILE -- DECL_FUNCTIONS.H
////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////